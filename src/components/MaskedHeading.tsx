/**
 * MaskedHeading — adapted from React Bits (https://reactbits.dev/text-animations/masked-heading),
 * MIT licensed. Media shows through the glyphs via an SVG clipPath; words rise in on view.
 */
